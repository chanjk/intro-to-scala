...
object OptionExercises2 {
  ...
  /**
    ...
    */
  def findJobDescriptionGivenJobIdOrElse1(jobId: JobId): String = findJobDescriptionGivenJobId2(jobId) match {
  ...
  /**
    ...
    */
  def findJobDescriptionGivenJobIdOrElse2(jobId: JobId): String = findJobDescriptionGivenJobId2(jobId).getOrElse(s"Job with id $jobId does not exist")
  ...
  /**
    ...
    */
  def findJobByHumanId(humanId: HumanId): Option[Job] = findJobIdByHumanId(humanId).flatMap(findJobById(_))
